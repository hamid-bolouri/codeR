...
```{r}
library(future)
plan(strategy = "multiprocess", workers = 96)    ############## set number of CPUs #################
...
setwd("~/__Data/shelfLifeLSE/")
load("Aggr_Human_Immunology_RTX-850-856_GRCh38-3.0.0_premrna_mat_v3_reads.RData")
