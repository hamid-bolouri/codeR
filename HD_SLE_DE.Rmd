...
```{r}
library(future)
plan(strategy = "multiprocess", workers = 68)    ############## set number of CPUs #################
...
for (N in c(5000, 2500, 1000, 500, 100, 50)) {
   ...
   # Subset by clusters 7 == B cells (CD19+CD22+CD79+)
   ...
   # setwd("~/__Data/shelfLife_LSE.v.HD")
   # saveRDS(myMat, file="shelfLife_SLE.HD_10Kreads.RDS")
